...
class MixedStatePresentation(MealyHMM):
    ...
    def to_recurrent(self) -> MealyHMM:
        ...
        as an :class:`~sofic.generators.epsilon_machine.EpsilonMachine`.  Otherwise
        the recurrent component remains a unifilar :class:`~sofic.generators.mealy.MealyHMM`
        over mixed states.
        """
    ...
    def _recurrent_initial_distribution(
        ...
        from sofic.generators.prob import simplify_prob
