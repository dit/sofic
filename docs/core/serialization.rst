.. serialization.rst
.. py:module:: pensive.serialization

*************
Serialization
*************

Every :class:`~pensive.core.StateMachine` round-trips through a self-describing
...
The instance methods :meth:`~pensive.core.StateMachine.to_yaml`,
:meth:`~pensive.core.StateMachine.write_yaml`,
:meth:`~pensive.core.StateMachine.from_yaml`, and
:meth:`~pensive.core.StateMachine.read_yaml` delegate to the module-level
