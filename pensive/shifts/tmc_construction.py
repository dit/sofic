...
from pensive.graph import ATTR_MULTIPLICITY, ATTR_SYMBOL, TransitionGraph
from pensive.shifts.algorithms import adjacency_matrix, topological_entropy_from_matrix
