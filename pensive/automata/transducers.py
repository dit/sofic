...
class MealyMachine(Transducer):
    ...
    def add_transition(
        ...
        **attrs: Any,
        ...
        Use :data:`pensive.graph.EPSILON` for empty input or empty output.
    ...
    def compose(self, other: MealyMachine, **kwargs: Any) -> MealyMachine:
        ...
        from pensive.automata.transducer_operations import compose_tt
    ...
    def joint_machine(self, generator: Any, **kwargs: Any) -> Any:
        ...
        from pensive.automata.transducer_operations import compose_tg
    ...
    def transduce_generator(self, generator: Any, **kwargs: Any) -> Any:
        ...
        from pensive.automata.transducer_operations import transduce_generator
