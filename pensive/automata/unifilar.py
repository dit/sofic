...
class UnifilarAutomaton(LabeledAutomaton):
    ...
    def markov_order(self) -> int | float:
        ...
        from pensive.generators.synchronization import graph_from_unifilar_automaton, markov_order_from_graph
    ...
    def cryptic_order(self) -> int | float:
        ...
        from pensive.generators.synchronization import cryptic_order_from_graph, graph_from_unifilar_automaton
    ...
    def is_exactly_synchronizable(self) -> bool:
        ...
        from pensive.generators.synchronization import graph_from_unifilar_automaton, is_exactly_synchronizable
