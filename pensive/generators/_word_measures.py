...
Leaf module shared by :mod:`pensive.generators.block_entropy` and
:mod:`pensive.generators.block_convergence`.  It depends only on ``dit`` (via
:func:`pensive.generators.measures.require_dit`) and must not import either
